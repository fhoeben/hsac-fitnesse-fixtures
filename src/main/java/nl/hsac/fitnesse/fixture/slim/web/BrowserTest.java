...
public class BrowserTest extends SlimFixture {
    ...
    private String screenshotBase = new File(fileSectionsHelper.getFilesDir(), "screenshots").getPath() + "/";
    private String screenshotHeight = "200";
    private String downloadBase = new File(fileSectionsHelper.getFilesDir(), "downloads").getPath() + "/";
    private String pageSourceBase = new File(fileSectionsHelper.getFilesDir(), "pagesources").getPath() + "/";
