 ...
 */
public class Ng2BrowserTest extends BrowserTest {
    private final static Set<String> METHODS_NO_WAIT;
    private String angularRoot;

    static {
        METHODS_NO_WAIT = ReflectionHelper.validateMethodNames(Ng2BrowserTest.class,
                "open",
                "takeScreenshot",
                "location",
                "back",
    ...
    public void waitForAngularRequestsToFinish(String root) {
        Object result = waitForJavascriptCallback(Ng2ClientSideScripts.WaitForAngular, root);
