    ...
    public static class Heuristic extends HeuristicBy {
        public Heuristic(String place) {
            super(LinkBy.exactText(place),
                    ...
                    new XPathBy(".//summary/descendant-or-self::text()[normalized(.)='%s']/ancestor-or-self::summary", place),
                    ...
                    new XPathBy(".//summary/descendant-or-self::text()[contains(normalized(.), '%s')]/ancestor-or-self::summary", place),
