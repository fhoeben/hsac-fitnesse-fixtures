...
import static nl.hsac.fitnesse.fixture.util.selenium.by.AriaGridBy.getXPathForColumnInRowByValueInOtherColumn;
import static nl.hsac.fitnesse.fixture.util.selenium.by.AriaGridBy.getXPathForColumnIndex;
import static nl.hsac.fitnesse.fixture.util.selenium.by.AriaGridBy.getXPathForHeaderRowByHeaders;
...
public abstract class Value extends SingleElementOrNullBy {
    public static class AtCoordinates extends Value {
        ...
        public WebElement findElement(SearchContext context) {
            ...
            return getValueByXPath(context, "(.//div[@role='row'][boolean(span[@role='cell'])])[%s]/span[@role='cell'][%s]", row, column);
        }
    }
    ...
    public static class OfInRowNumber extends Value {
        ...
        public WebElement findElement(SearchContext context) {
            ...
            String columnXPath = String.format("((.//div[@role='table'][./%1$s])[last()]//div[@role='row'][boolean(span[@role='cell'])])[%2$s]/span[@role='cell']", headerXPath, rowIndex);
