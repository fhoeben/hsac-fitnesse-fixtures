...
/**
 * This class is a copy of selenium's trunk version that incorporates a fix for broken relative locators in alpha 6
 * See: (https://github.com/SeleniumHQ/selenium/pull/8424)
 *
 * It is deprecated, as it should be removed and replaced with its original version
 * (org.openqa.selenium.support.locators.RelativeLocator) when a new release comes out.
 */
    ...
    static {
        try {
            String location = String.format(
                    "/%s/%s",
                    org.openqa.selenium.support.locators.RelativeLocator.class.getPackage().getName().replace(".", "/"),
                    "findElements.js");
